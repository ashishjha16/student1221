...
urlpatterns = [
    ...
    path('add_class_teacher/', HodViews.add_class_teacher, name="add_class_teacher"),
    path('manage_class_teacher/', HodViews.manage_class_teacher, name="manage_class_teacher"),
    path('add_class_teacher_save/', HodViews.add_class_teacher_save, name="add_class_teacher_save"),
    path('edit_class_teacher/<str:class_teacher_id>/', HodViews.edit_class_teacher, name="edit_class_teacher"),
    path('edit_class_teacher_save/', HodViews.edit_class_teacher_save, name="edit_class_teacher_save"),
#     Staff URL Path
    ...
    path('save_edit_result',StaffViews.save_edit_result,name="save_edit_result"),
    ...
    path('class_teacher_students/', StaffViews.class_teacher_students, name="class_teacher_students"),
    ...
    path('student_attendance_calendar',StudentViews.student_attendance_calendar,name="student_attendance_calendar"),
    path('get_student_attendance_by_date',StudentViews.get_student_attendance_by_date,name="get_student_attendance_by_date"),
    path('get_student_attendance_by_date',StudentViews.get_student_attendance_by_date,name="get_student_attendance_by_date"),
    path('staff_add_notice/',StaffViews.staff_add_notice,name="staff_add_notice"),
    path('staff_add_notice_save/',StaffViews.staff_add_notice_save,name="staff_add_notice_save"),
    path('student_view_notice/',StudentViews.student_view_notice,name="student_view_notice"),
    ...
    path('student_grade_card/',StudentViews.student_grade_card,name="student_grade_card"),
