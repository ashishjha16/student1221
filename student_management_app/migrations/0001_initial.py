# Generated by Django 5.2.14 on 2026-05-17 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('year', models.CharField(choices=[('FY', 'First Year'), ('SY', 'Second Year'), ('TY', 'Third Year'), ('Final', 'Final Year')], default='FY', max_length=10)),
                ('division', models.CharField(choices=[('A', 'A Division'), ('B', 'B Division')], default='A', max_length=5)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('fcm_token', models.TextField(default='')),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('class_teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='student_management_app.classteacher')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('assignment_marks', models.FloatField(blank=True, null=True)),
                ('ct1_marks', models.FloatField(blank=True, null=True)),
                ('ct2_marks', models.FloatField(blank=True, null=True)),
                ('midsem_marks', models.FloatField(blank=True, null=True)),
                ('practical_marks', models.FloatField(blank=True, null=True)),
                ('endsem_marks', models.FloatField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.students')),
