...
from student_management_app.models import Notice, ClassTeacher
from student_management_app.models import Assignment
import openpyxl
import csv
from django.http import HttpResponse
from student_management_app.models import AttendanceReport, Students
    ...
    for student in students:
        ...
        for date in attendance_dates:
            ...
            attendance = AttendanceReport.objects.filter(
                student_id=student,
                attendance_id__attendance_date=date,
                attendance_id__subject_id__in=subjects
            ).first()
...
def class_teacher_students(request):
    ...
    return render(
        request,
        "staff_template/class_teacher_students.html",
        context
    )
